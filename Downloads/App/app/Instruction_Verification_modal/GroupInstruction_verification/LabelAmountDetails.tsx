...
const LabelAmountDetails = ({Instruction_verificationData, setInstruction_verificationData,Signatory_listData, setSignatory_listData,}:any) => {
...
useEffect(() => {
  ...
  return (
    <div className="col-start-1 col-end-5 row-start-1 row-end-2 gap-10px" >
      <Label 
      >
      Amount Details
      </Label>
...
export default LabelAmountDetails