...
const LabelWithdrawalInstruction = ({Instruction_verificationData, setInstruction_verificationData,Signatory_listData, setSignatory_listData,}:any) => {
...
useEffect(() => {
  ...
  return (
    <div className="col-start-1 col-end-5 row-start-6 row-end-7 gap-" >
      <Label 
      >
...
export default LabelWithdrawalInstruction